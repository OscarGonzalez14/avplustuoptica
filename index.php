              ...
              <div class="col-lg-5">
                <div class="h-100">
                  <div class="mb-5 d-flex align-items-center">
                    <div>
                      <a href="images/about.mp4" class="popup-vimeo d-block play"><span class="icon-play"></span></a>
                    </div>
                    <h2>Quienes Somos</h2><!--<img src="images/paralax2.jpg" alt="Image" class="img-feature img-fluid" height="300" width="300">-->
                  </div>
                  
                </div>
              </div>
              
              <h5 style="text-align: left"> <i class="fa fa-map-marker" aria-hidden="true"></i><strong>  Centro Comercial MetroCentro 4ta. Etapa, Local 7&nbsp;&nbsp;||&nbsp;&nbsp;</strong><i class="fa fa-phone" aria-hidden="true"></i> <strong>22601653</strong></h5>
