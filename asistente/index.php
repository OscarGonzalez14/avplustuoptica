...
<form action="../ajax/asistente_afiliaciones.php" method="post">
      <div class="row">
        <div class="input-field col s12">
          <input id="nombre" name="nombre" type="text" class="browser-default">
        ...
        <div class="input-field col s12">
           <select name="periodo_pago" id="periodo_pago">         
           </select>
        </div>  

        <div class="input-field col s8">
          <input id="numero_tarjeta" type="text" class="numero_tarjeta" name="numero_tarjeta"> <i class="fa fa-credit-card-alt fa-2x card" aria-hidden="true" id="icono"></i>
        ...
        <div class="input-field col s4">
          <input id="fecha_vec" name="fecha_vec" type="text" class="fecha_vec" placeholder="MM/AAAA" maxlength="7"> 
...
<div class="row">
        ...
        <div class="col s10 offset-s1 center-align">
            <button class="btn waves-effect waves-light" type="submit" name="action" style="background-color: black">
                Enviar
